!function (e) {
    ...
    var a, s, n, o = ".ajax-contact", i = "is-invalid", r = '[name="email"]',
        l = '[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]', c = e(".form-messages");

    function d () {
        var t = e(o).serialize();
        p() && jQuery.ajax({url: e(o).attr("action"), data: t, type: "POST"}).done((function (t) {
    ...
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function () {
        ...
        e(this).each((function () {
            ...
            s = c.attr(t), n = c.attr(a), o = c.data("margin-top"), i = c.data("margin-bottom"), r = u(e(n).css("padding-top")), l = u(e(n).css("padding-bottom")), "margin-top" === s ? (e(n).css("padding-bottom", l + u(o) + "px"), c.css("margin-top", "-" + u(o) + "px").css({
                position: "relative",
                "z-index": "3"
            })) : "margin-bottom" === s && (e(n).css("padding-top", r + u(i) + "px"), c.css("margin-bottom", "-" + u(i) + "px").css({
                position: "relative",
                "z-index": "3"
            }))
        }))
    ...
    e("[data-sec-space]").length && e("[data-sec-space]").imagesLoaded((function () {
        ...
        var t = e(this), a = t.find("a"), s = t.find("button");
        t.append('<span class="indicator"></span>');
        var n = t.find(".indicator");
        if (a.length) var o = a; else if (s.length) o = s;

        function i () {
            var e = t.find(".active"), a = e.css("height"), s = e.css("width"), o = e.position().top + "px",
        ...
        e(this).each((function () {
            ...
            function r () {
                var o = t.find(a.tabButton + ".active"), i = o.css("height"), r = o.css("width"),
                    l = o.position().top + "px", c = o.position().left + "px";
        ...
        e(this).each((function () {
            var t = e(this), a = t.data("top"), s = t.data("right"), n = t.data("bottom"), o = t.data("left");
            t.css({
                top: a,
                right: s,
                bottom: n,
